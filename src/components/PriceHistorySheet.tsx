      ...
      >
        ...
        <div className="bg-gray-50 rounded-2xl p-3 mb-4 space-y-2">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <button onClick={handleShare} className="w-12 h-11 rounded-xl bg-gray-100 text-gray-700 hover:bg-gray-200 inline-flex items-center justify-center transition-colors" aria-label="Share">
              <Share2 className="w-4 h-4" />
            </button>
            <button onClick={handleSave} className={`w-12 h-11 rounded-xl inline-flex items-center justify-center transition-colors ${isSaved ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`} aria-label="Save">
